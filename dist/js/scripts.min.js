 ...
 */
!function(e,n){if("function"==typeof define&&define.amd)define(["ScrollMagic","gsap","TweenMax","TimelineMax"],n);else if("object"==typeof exports){var t=require("gsap/dist/gsap")||require("gsap");n(require("scrollmagic"),t,TweenMax||t,TimelineMax||t)}else n(e.ScrollMagic||e.jQuery&&e.jQuery.ScrollMagic,e.gsap,e.gsap||e.TweenMax||e.TweenLite,e.gsap||e.TimelineMax||e.TimelineLite)}(this,(function(e,n,t,r){"use strict";var i=n&&parseFloat(n.version)>=3,o=window.console||{};Function.prototype.bind.call(o.error||o.log||function(){},o);e.Scene.addOption("tweenChanges",!1,(function(e){return!!e})),e.Scene.extend((function(){var e,n=this,o=function(){n._log&&(Array.prototype.splice.call(arguments,1,0,"(animation.gsap)","->"),n._log.apply(this,arguments))};n.on("progress.plugin_gsap",(function(){a()})),n.on("destroy.plugin_gsap",(function(e){n.removeTween(e.reset)}));var a=function(){if(e){var t=n.progress(),r=n.state();e.repeat&&-1===e.repeat()?"DURING"===r&&e.paused()?e.play():"DURING"===r||e.paused()||e.pause():t!=e.progress()&&(0===n.duration()?t>0?e.play():e.reverse():n.tweenChanges()&&e.tweenTo?e.tweenTo(t*e.duration()):e.progress(t).pause())}};n.setTween=function(s,l,p){var g;if(arguments.length>1){var c="number"==typeof arguments[1];i?(c||(p=l),p.hasOwnProperty("duration")||(p.duration=c?l:1)):arguments.length<3&&(p=l,l=1),s=i?t.to(s,p):t.to(s,l,p)}try{(g=r&&!i?new r({smoothChildTiming:!0}).add(s):s).pause()}catch(e){return o(1,"ERROR calling method 'setTween()': Supplied argument is not a valid TweenObject"),n}if(e&&n.removeTween(),e=g,s.repeat&&-1===s.repeat()&&(e.repeat(-1),e.yoyo(s.yoyo())),n.tweenChanges()&&!e.tweenTo&&o(2,"WARNING: tweenChanges will only work if the TimelineMax object is available for ScrollMagic."),e&&n.controller()&&n.triggerElement()&&n.loglevel()>=2){var u=t.getTweensOf(n.triggerElement()),f=n.controller().info("vertical");u.forEach((function(e,n){var t=e.vars.css||e.vars;if(f?void 0!==t.top||void 0!==t.bottom:void 0!==t.left||void 0!==t.right)return o(2,"WARNING: Tweening the position of the trigger element affects the scene timing and should be avoided!"),!1}))}if(parseFloat(TweenLite.version)>=1.14)for(var d,v,w=i?"onInterrupt":"onOverwrite",h=e.getChildren?e.getChildren(!0,!0,!1):[e],m=function(){},T=0;T<h.length;T++)d=h[T],v!==m&&(v=d.vars[w],d.vars[w]=function(){v&&v.apply(this,arguments),m.apply(this,arguments)});return o(3,"added tween"),a(),n},n.removeTween=function(t){return e&&(t&&e.progress(0).pause(),e.kill(),e=void 0,o(3,"removed tween (reset: "+(t?"true":"false")+")")),n}}))}));
function drawSvg(){var e,a,n=$("#pathAyuda");a=(e=n)[0].getTotalLength(),e.css("stroke-dasharray",a),e.css("stroke-dashoffset",a);var r=new ScrollMagic.Controller,t=(new TimelineMax).add(TweenMax.to(n,.5,{strokeDashoffset:0,ease:Linear.easeNone})).add(TweenMax.to("path",1,{ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerElement:"#triggerAyuda",duration:600,tweenChanges:!0}).setTween(t).addTo(r)}drawSvg();
